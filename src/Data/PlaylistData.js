...
// Artist
import AtifAslam from '../assets/Artist/AtifAslam1.jfif'
import AtifAslam2 from '../assets/Artist/AtifAslam2.jpg'
...
const PlaylistData = [
  ...
  {
    artist: 'Atif Aslam',
    artistId: 'f2820769-7126-4af9-a277-4128ffa500aa',
    ProfieImg: AtifAslam2,
    AboutImg: AtifAslam,
    MonthlyListeners: '59,892,410',
    Followers: '45,485,45',
    Description: 'decs',
    albums: [
      {
        albumID: '5bbaa9eb-b92e-4692-807c-2fe8aef8e929',
        title: 'Doorie',
        bgColor: "bg-gradient-to-r from-red-900 via-rose-950 to-amber-950",
        release_date: "2004",
        cover: Doorie,
      ...
      {
        albumID: 'f0bfeb3b-cdf8-46ae-a4a1-9504733a0434',
        title: 'Jal Pari',
        bgColor: "bg-gradient-to-r from-red-900 via-rose-950 to-amber-950",
        release_date: "2004",
        cover: Doorie,
