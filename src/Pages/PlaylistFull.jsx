...
function PlaylistFull() {
  ...
  return (
    <Layout>
      <div className="h-[40rem] overflow-y-hidden hover:overflow-y-scroll ">
        <div className="" style={{ margin: 0 }}>
          <div className={`flex w-full py-10 px-6 ${item?.bgColor}`}>
            <div className="pt-10 flex drop-shadow-lg">
              ...
              <div className="mx-8 mt-10">
                ...
                <div className="flex items-center gap-2 mt-4 ">
                  <p className=" text-gray-100">{item?.artist} - </p>
                  <p className="text-gray-200">{item.release_date}</p>
                  <span className="font-thin text-gray-300">
                    {item.totalSong} songs,
                  </span>
