...
export const Artists = () => {
  ...
  return (
    <Layout>
      <div className="h-[45rem] overflow-scroll" style={{ margin: 0 }}>
        <div className="text-white h-[40vh] ">
          ...
          <h1 className="relative top-[-11rem] left-7 text-8xl cursor-default">
            {artist.artist}
          </h1>
        ...
        <div className="mx-4">
          ...
          <div className="main mt-8 text-white">
            ...
            <div className="">
              <p className="mt-4 text-2xl">Artist Pick</p>
              <div className="">
            ...
            <div className="bg-[#272727] h-64">
              <div className="flex justify-between">
                <img
                  ...
                  alt=""
                />
                <div className="text-white pr-2 w-24 h-24 bg-blue-600 rounded-full">
          ...
          <div className="bg-[#121212] text-white py-5 px-8 ">
            <div className="text-white pr-2 w-20 h-20 bg-blue-600 rounded-full">
                <p className="text-4xl relative left-5">#1</p>
                <p className="relative left-5 top-[-6px]">in the world</p>
              </div>
            <p className="text-4xl">{artist.Followers}</p>
